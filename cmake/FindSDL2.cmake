if(NOT ${CMAKE_FIND_PACKAGE_NAME}_FOUND)
	...
	set(Core_HEADER "SDL2/SDL_version.h")
	set(Main_HEADER "SDL2/SDL_main.h")
	set(Core_LIB "SDL2")
	set(Main_LIB "SDL2main")
	...
	if(${PACKAGE_NAME_UPPER}_CORE_INCLUDE_DIR AND EXISTS "${${PACKAGE_NAME_UPPER}_CORE_INCLUDE_DIR}/${Core_HEADER}")
		set(VERSION_FILE "${${PACKAGE_NAME_UPPER}_CORE_INCLUDE_DIR}/${Core_HEADER}")

		file(STRINGS ${VERSION_FILE} SDL2_VERSION_MAJOR_LINE REGEX "^#define[ \t]+SDL_MAJOR_VERSION[ \t]+[0-9]+$")
		file(STRINGS ${VERSION_FILE} SDL2_VERSION_MINOR_LINE REGEX "^#define[ \t]+SDL_MINOR_VERSION[ \t]+[0-9]+$")
		file(STRINGS ${VERSION_FILE} SDL2_VERSION_PATCH_LINE REGEX "^#define[ \t]+SDL_PATCHLEVEL[ \t]+[0-9]+$")
		string(REGEX REPLACE "^#define[ \t]+SDL_MAJOR_VERSION[ \t]+([0-9]+)$" "\\1" SDL2_VERSION_MAJOR "${SDL2_VERSION_MAJOR_LINE}")
		string(REGEX REPLACE "^#define[ \t]+SDL_MINOR_VERSION[ \t]+([0-9]+)$" "\\1" SDL2_VERSION_MINOR "${SDL2_VERSION_MINOR_LINE}")
		string(REGEX REPLACE "^#define[ \t]+SDL_PATCHLEVEL[ \t]+([0-9]+)$" "\\1" SDL2_VERSION_PATCH "${SDL2_VERSION_PATCH_LINE}")
		set(${PACKAG_NAME_UPPER}_VERSION_STRING ${SDL2_VERSION_MAJOR}.${SDL2_VERSION_MINOR}.${SDL2_VERSION_PATCH})
